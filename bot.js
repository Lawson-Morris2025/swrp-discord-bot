...
client.on('interactionCreate', async (interaction) => {
    // ---- ROBUST SERVER SAFETY CHECK ----
    // This looks at multiple data points to prove the interaction is inside a server text channel
    ...
    // Safely retrieve the guild object even if partial cache occurs
...
// Interaction Handling
client.on('interactionCreate', async (interaction) => {
    // Block interaction if executed in DMs
